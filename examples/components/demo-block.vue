...
import { stripScript,stripStyle,stripTemplate } from '../utils/strip';
const { version }=CastorUI;
...
export default {
  ...
  computed: {
    ...
    controlText() {
      return this.isExpanded? this.config['hide-text']:this.config['show-text'];
    },
