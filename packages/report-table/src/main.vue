<template>
  <div v-if="hackReset" class="report-table-container">
    <div class="table-commands">
      <el-button
        ...
        :disabled="
          addCommand.disableValidator && addCommand.disableValidator.call(this)
        "
        v-bind="{
          type: 'text',
      ...
      <el-button-group v-if="customCommands" class="table-custom-commands">
        <el-button
